...
# <span style="color: plum"> Creating Manhattan Plots with PrediXcan Results </span>

## <span style="color: orchid"> 1. Read in the gene annotation file </span>

* <span style="color: palevioletred"> Download gene annotation file from</span> [GENCODE](https://www.gencodegenes.org/human/)
* <span style="color: palevioletred"> This file contains the starting and ending positions of different genes </span>
...
## <span style="color: orchid"> 2. Creating the plots   </span>
* <span style="color: palevioletred"> The following code is a for loop creating four different plots </span>
* <span style="color: palevioletred"> The plots contain data from either META or AFR populations with either the Chronotype or Sleep Duration Phenotype </span>
```{r, eval=FALSE}
